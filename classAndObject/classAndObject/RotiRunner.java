class RotiRunner {
    public static void main(String[] args) {
        ...
        Roti r3 = new Roti();
        r3.type = "Missi Roti";
        r3.flourUsed = "Besan & Wheat";
        r3.diameterInInches = 6.5;
        r3.isStuffed = false;
        r3.region = "Rajasthan";
        r3.isHot = true;
